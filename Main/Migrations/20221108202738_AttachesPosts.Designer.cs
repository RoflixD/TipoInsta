...
namespace Main.Migrations
{
    ...
    [Migration("20221108202738_AttachesPosts")]
    partial class AttachesPosts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entites.PostContent", b =>
                {
                    b.HasBaseType("DAL.Entites.Attach");
            ...
            modelBuilder.Entity("DAL.Entites.Avatar", b =>
                {
                    ...
                    b.HasOne("DAL.Entites.User", "Owner")
                        .WithOne("Avatar")
                        .HasForeignKey("DAL.Entites.Avatar", "OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Entites.PostContent", b =>
                {
                    b.HasOne("DAL.Entites.Attach", null)
                        .WithOne()
                        .HasForeignKey("DAL.Entites.PostContent", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
